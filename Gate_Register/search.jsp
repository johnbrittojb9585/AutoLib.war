...
<form name="Member_Find" method="post" action=./EgateReportsSearch >
<%
...
<%
	...
	mainTitle="Desig"; Title="Desig&nbsp;Name";t1="Desig&nbsp;Code";t2="Remarks";
	%>
	<script>document.Member_Find.sflag.value="<%=flag%>";</script>
	<%
	}
...
window.opener.document.Gate_Register.Dname.value=val;
}
if(document.Member_Find.sflag.value=="Group"){
window.opener.document.Gate_Register.Gname.value=val;
}
if(document.Member_Find.sflag.value=="Desig"){
	window.opener.document.Gate_Register.Desig.value=val;
	}
