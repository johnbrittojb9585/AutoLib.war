...
String flag="",Message="",load="",detils="",flags="",avoid="",DisplayDate="",DisplayDate1="",checkTitle="";
%>
...
<%-- <script type="text/javascript" src="<%=request.getContextPath()%>/js/searchBulkCounter.js"></script> --%>
...
<h2><b>Bulk&nbsp;Counter&nbsp;Service</b></h2>
 <%
...
<div class="search-container">
	<div class="ui-widget">
      ...
      <td><input type="text" name="mcode" id="searchBulkCounterUserId" class="searchBulkCounter" onkeyup="showBulkCounterMemberId(this.value);" size="17"  maxlength="15" onFocus="memopt()" >
...
%>
  ...
  <div class="search-container">
	<div class="ui-widget">
      ...
      <td ><input type="text" name="accno" id="searchBulkCounterAccessNo" class="searchBulkCounter" onkeyup="showBulkCounterAccessNo(this.value);" size="17" maxlength="15" onFocus="bookopt()" >
    ...
    <tr>
      <td colspan="8"><center>
		...
		<input onclick="search_record()" type="submit" Class="counterButton" value="Search">		
 ...
 <a href="javascript:void();" onclick="javascript:checkAll('counter', false);">None</a>
  <jsp:include page="CounterListdisplay.jsp" flush="true" /></td>
  </tr>
  </table>
 </td>
