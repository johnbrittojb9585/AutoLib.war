...
<div id="display>
	...
	<display:table name="requestScope.BulkCounterList" id="counterlistBean" pagesize="30" 
		...
		requestURI="/Bulk_Counter/CounterListdisplay.jsp" decorator="org.displaytag.decorator.TotalTableDecorator">

		<display:column>
				<input type="checkbox" checked name="selectedIds[]" value='<c:out value="${counterlistBean.accessNo}"/>'>
    	...
    	<display:column property="authorName" title="Author Name"  maxLength="50"> 
		</display:column>
		
		<display:column property="publisher" title="Publisher Name"  maxLength="50"> 
		</display:column>
		...
		<display:column property="temp" title="Fine Amount"  maxLength="10" format="{0,number,0}" total="true"> 
		</display:column>
