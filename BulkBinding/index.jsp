...
<tr><td> &nbsp; </td></tr>
    <tr>
      ...
      <td>
      <SELECT SIZE="1" NAME="txtBinder" style="width:160px">
...
&nbsp; </select>
    ...
    <tr>
      ...
      <input type="button" Class="submitButton" value="New" name="display" onclick="new_binding()">
