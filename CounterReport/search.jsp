...
<form name="Member_Find" method="post" action=./CounterReportsSearch >
<%
...
window.opener.document.query.Dname.value=val;
}
if(document.Member_Find.sflag.value=="Group"){
window.opener.document.query.Gname.value=val;
}
if(document.Member_Find.sflag.value=="staffcode"){
	window.opener.document.query.Sname.value=val;
	}
