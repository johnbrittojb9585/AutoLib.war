...
String flag="",Message="",count="",load="",detils="",flags="",avoid="",DisplayDate="",DisplayDate1="";
%>
...
<form name="counter" method="post" action=./BulkReturnCounterServlet>

<h2><b>Bulk&nbsp;ReturnCounter&nbsp;Service</b></h2>
 <%
...
<!--        <input type=button name=Find_Member Class="submitButton"  Value="Find" onclick=FindValue('Member')> --></td>
      <td bgcolor="#BCD6E2" bordercolor="#FFE6BC"><input type="radio" value="V1" name="sel_search"><b Class="addedit">User</b></td>
...
out.print("<b><font face=Verdana size=2 color=#ff00ff>'"+count+"' Document returned successfully!!!</font></b>");
...
%>
	  ...
	  <td bgcolor="#BCD6E2" bordercolor="#FFE6BC"><b><input type="radio" value="V2" checked name="sel_search" Class="addedit">Resource</td>
...
<!--         <input onclick="issue()" type="button" Class="submitButton" value="F6-Issue" name="issuebutton"> -->
        <input onclick="ireturn()" type="button" Class="counterButton" value="F7-Return" name="returnbutton">
<!-- 		<input onclick="renew()" type="button" Class="submitButton" value="F9-Renew" name="renewbutton"> -->
		...
		<input type="Reset" value="F3-Reset" Class="counterButton" onclick="rsetpage()">
...
if(document.counter.sel_search[1].checked)
{
...
%><script>
alert(" This Document Not Issued");
</script><%
flag="member";
}
if(flag.equals("NotIssued")){
%><script>
alert(" This Document Not Issued");
</script><%
}
