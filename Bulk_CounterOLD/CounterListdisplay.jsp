...
<div id="displayTag">
	...
	<display:table name="sessionScope.BulkCounterList" id="counterlistBean" pagesize="30" 
		class="dataTable" sort="list" defaultsort="2" defaultorder="ascending"
		requestURI="/Bulk_Counter/CounterListdisplay.jsp">

		<display:column>
				<input type="checkbox" name="selectedIds[]" value='<c:out value="${counterlistBean.accessNo}"/>'>
		...
		<display:column property="temp" title="Fine Amount"  maxLength="10"> 
		</display:column>
