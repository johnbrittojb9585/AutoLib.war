...
public void performTask(HttpServletRequest request,
		...
		try {
			...
			if(value.equals("staffcode")){
				System.out.println("::::::inside Staff code search::::::::");
				  List GroupArrylist = new ArrayList();
			    	ob=new MemberBean();
			    	ob.setName(nm);
			    	GroupArrylist=ss.getStaffSearch(ob);
					System.out.println("::::::inside Staff code search22222222222222::::::::");
					request.setAttribute("serarch", GroupArrylist);
					indexPage = "/FineCollectionReport/search_nmvc.jsp?check=ok&flag="+value+"&nam="+nm+"";
					dispatch(request, response, indexPage);	
		    }
