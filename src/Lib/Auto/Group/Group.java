...
public class Group extends HttpServlet implements Serializable {
	...
	int Group_savegrper=0,Group_savebrper=0,Group_savebbrper=0,Group_savebvrper=0,Group_savenbrper=0,Group_savejrper=0,Group_savesrper=0,Group_saverrper=0,Group_saveprper=0,Group_savetrper=0,Group_savereserve=0;
...
if(flag!=null){
		...
		// RK Start at 17-09-2014 3:40 PM
		if(!request.getParameter("GRperiod").trim().equals(""))
		Group_savegrper=Integer.parseInt(request.getParameter("GRperiod"));
		if(!request.getParameter("BRperiod").trim().equals(""))
		Group_savebrper=Integer.parseInt(request.getParameter("BRperiod"));
		if(!request.getParameter("BBRperiod").trim().equals(""))
		Group_savebbrper=Integer.parseInt(request.getParameter("BBRperiod"));
		if(!request.getParameter("BVRperiod").trim().equals(""))
		Group_savebvrper=Integer.parseInt(request.getParameter("BVRperiod"));
		if(!request.getParameter("NBRperiod").trim().equals(""))
		Group_savenbrper=Integer.parseInt(request.getParameter("NBRperiod"));
		if(!request.getParameter("JRperiod").trim().equals(""))
		Group_savejrper=Integer.parseInt(request.getParameter("JRperiod"));
		if(!request.getParameter("SRperiod").trim().equals(""))
		Group_savesrper=Integer.parseInt(request.getParameter("SRperiod"));
		if(!request.getParameter("RRperiod").trim().equals(""))
		Group_saverrper=Integer.parseInt(request.getParameter("RRperiod"));
		if(!request.getParameter("PRperiod").trim().equals(""))
		Group_saveprper=Integer.parseInt(request.getParameter("PRperiod"));
		if(!request.getParameter("TRperiod").trim().equals(""))
		Group_savetrper=Integer.parseInt(request.getParameter("TRperiod"));		
		...
		if(!request.getParameter("BReserve").trim().equals(""))  // RK Start
		Group_savereserve=Integer.parseInt(request.getParameter("BReserve"));  
		...
		if(Group_savestatus==null)
		{
			...
			if(flag.equals("update")){
				...
				ob.setCode(Group_savecode);
				 ...
				 ob.setGrper(Group_savegrper);  // RK Start
				 ob.setBrper(Group_savebrper);
				 ob.setBbrper(Group_savebbrper);
	             ob.setBvrper(Group_savebvrper);
				 ob.setNbrper(Group_savenbrper);
				 ob.setJrper(Group_savejrper);
				 ob.setSrper(Group_savesrper);
				 ob.setRrper(Group_saverrper);
				 ob.setPrper(Group_saveprper);
				 ob.setTrper(Group_savetrper);				 
				 ob.setReserve(Group_savereserve);	
