...
public class BookDataBean {
	...
	private int budgetCode = 1; // For Creating with Nil Budget
	private int noOfCopy = 1; // For Creating with only one Copy

	private String availability = "YES"; // For Creating with YES Availability
	private String otherDate = "1800-01-01"; // For Default date
	private String role = "AUTHOR";
	private String AVtype = "UG";

	private Double bcost = 0.0;
	private String currency = "1.0";

	private String otherTitle = "";
	private String stateRes = "";
	private String place = "";
	private String size = "NO";
	private String illustration = "";
	private String isbn = "";
	private String script = "";
	private String physical = "PAPER PACK";
	private String binding = "PAPER PACK";
