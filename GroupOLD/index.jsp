...
<tr><td Class="addedit">
Remarks<td colspan=4 >
    <input type=text name=Remarks size=37>
    <td Class="addedit">
    Renewal</td><td colspan=2>
    <input  type=text name=Renewal size=13  value="0" onKeyUp="return group_code_val();">
    </td></tr>
    <tr>
    <td colspan="8" ><center>
...
for(var i=1;i<document.Grp.elements.length;i++){
	...
	if(document.Grp.elements[i].type=="text" && document.Grp.elements[i].name!="GName" && document.Grp.elements[i].name!="GCode" && document.Grp.elements[i].name!="Remarks" && document.Grp.elements[i].name!="Renewal")
...
document.Grp.ra3.checked=false;
	for(var i=1;i<document.Grp.elements.length;i++){
	if(document.Grp.elements[i].type=="text" && document.Grp.elements[i].name!="Geligible" && document.Grp.elements[i].name!="Gperiod" && document.Grp.elements[i].name!="GName" && document.Grp.elements[i].name!="GCode" && document.Grp.elements[i].name!="Remarks" && document.Grp.elements[i].name!="Renewal")
...
document.Grp.ra3.checked=false;
	...
	if(document.Grp.elements[i].name=="Geligible" || document.Grp.elements[i].name=="Gperiod")
	document.Grp.elements[i].readOnly=true;
	else
	document.Grp.elements[i].readOnly=false;
	}
...
document.Grp.Geligible.readOnly=false;
	for(var i=1;i<document.Grp.elements.length;i++){
	if(document.Grp.elements[i].type=="text" && document.Grp.elements[i].name!="Geligible" && document.Grp.elements[i].name!="GName" && document.Grp.elements[i].name!="GCode" && document.Grp.elements[i].name!="Remarks" && document.Grp.elements[i].name!="Renewal")
	if(document.Grp.elements[i].name.indexOf("period")==-1 || document.Grp.elements[i].name=="Gperiod")
		document.Grp.elements[i].readOnly=true;
    else
	document.Grp.elements[i].readOnly=false;
    }
