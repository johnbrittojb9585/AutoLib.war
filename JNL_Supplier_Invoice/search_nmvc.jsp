...
<form name=ord_find method=post action=./SupInvoiceJNLServlet>
<!--
...
<!--
//////////////////////////////////////FORM CONTROLS//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<h2 >Journal Supplier Invoice Search</h2>
...
<%
		if (flag.equals("Sup")){
		   ...
		   out.print("<tr><th>Opt<th>Order Number<th>SP_Name</tr>");
...
if (flag.equals("SupInvoice")){
    ...
    sc=(ArrayList)request.getAttribute("search");
	   ...
	   out.print("<table border=1 bordercolor=#008000 align=center cellspacing=0 >");
	   out.print("<tr><th>Invoice Number<th>SP_Name</tr>");
...
function show(val){
if(document.ord_find.flag.value=="SupInvoice"){
