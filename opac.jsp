...
else
{
	...
	console.log(document.form1.txtpasword.value);
...
function isBase64(str) {
	console.log("Checking isBase64 ::" + str);
	if (str === '' || str.trim() === '') {
		return false;
	}
	try {
...
<body class="front" onload="validate()">

<form hidden action="/AutoLib/Login" name="form1" method="post"  onsubmit="return validate()" >
...
<!--          <img src="/AutoLib/images/S1.jpg" alt="" width="130" height="146" border="0" />-->
          ...
          <font size=6 face="Bookman Old style"  color="#104e8b">Panimalar College Of Nursing</font><br>
         <font size=4 face="Bookman Old style" color="#310202" ><b>VARADHARAJAPURAM, POONAMALLEE, CHENNAI 600123</b></font>
          </td>
          <td width="17%" height="80">
          &nbsp;
          </td> 
          ...
          <td width="30%" height="100">
            ...
            <tr>
              ...
              <tr>
                ...
                <td width="67%">
                <input type="text" name="txtuserid" value="WebOpac"  />
                </td>
              </tr>
              <tr>
                <td width="33%">
                ...
                <td width="67%">
                 <input type="password" name="txtpasword" value="WebOpac"/>
                </td>
              </tr>
              <tr>
...
<font color="white"><b><center></>This Application is best viewed in  Chrome Browser and Firefox 20+ @ 1024 x 768 resolution and above.</center></b></font>
