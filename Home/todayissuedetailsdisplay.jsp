...
<div id="displayTag">
	...
	<display:table name="sessionScope.IssueReportArrylist" id="reportbean" pagesize="20" 
		class="dataTable" sort="list" defaultsort="1"
		 requestURI="/Home/todayissuedetails.jsp" export="true">
		...
		<display:column property="authorName"  title="Author&nbsp;Name"  maxLength="25" > 	
