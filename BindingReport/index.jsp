				...
				<tr>
					<td>
						...
						<table align="center" width="90%">
							...
							<tr>
								<td Class="addedit"><input type=radio value=byaccno
									name=acc onclick=change()>By&nbsp;Acc.&nbsp;No.</td>
								<td Class="addedit">From</td>
								<td><input type="text" name="From_Accno" size="17"
									maxlength=10></td>
								<td Class="addedit">To</td>
								<td><input type="text" name="To_Accno" size="17"
									maxlength=10></td>
							</tr>

							<tr>
								<td Class="addedit"><input type=radio value=bydate
									name=acc1 onclick=changes() checked>By Date</td>
								<td Class="addedit">From</td>
								<td>
									<%-- 	<INPUT name=fromdt size=11  onfocus=this.blur(); value="<%=dateString%>" > --%>
									<INPUT name=fromdt size=11 id="datepicker"
									value="<%=dateString%>">
								...
								<td>
									...
									<INPUT name=todt size=11 id="datepicker2"
									value="<%=dateString%>">
							...
							<input type="button" Class="submitButton" value="Print"name="Access_Print" onclick="Print_Report()">
										...
										<a href="#" onclick="Print_ExcelReport()"> <img
											src="<%=request.getContextPath()%>/images/xls.gif" width="35"
											height="40" border="0" title="Print Excel"></a> <input
											type="hidden" name="flag"> <input type="hidden"
											name="flagExcel"> <input type="hidden" name="flagNo">
										<input type="hidden" name="flagNotNumber"> <input
											type="hidden" name="randomNumberList"> <input
											type="hidden" name="firstStr"> <input type="hidden"
											name="secondStr"> <input type="hidden"
											name="firstNum"> <input type="hidden"
											name="secondNum">
...
function myRndNoInsertFunction() {
    ...
    option.text = document.Binding_Report.RndNo.value;
 
    x.add(option);
     document.Binding_Report.RndNo.value="";
...
function change(){//accessno

document.Binding_Report.acc1.checked=false;
document.Binding_Report.randomNumber.checked=false;
}
