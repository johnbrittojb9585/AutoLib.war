...
<form method="post" name="ordinv" action=./JnlOrdReportServlet>
<br><br><br>
<h2 >Journal Order Report</h2>
<center>
...
<tr>
<TD>
              <INPUT TYPE="radio" VALUE="Simple" NAME="reporttype" checked>&nbsp;Simple</TD>
            <TD>
              <INPUT TYPE="radio" VALUE="Advanced" NAME="reporttype">&nbsp;Advanced</TD>
            <TD>
</tr>

<tr>         
      <td Class="addedit">Ord.Ref-No</td>
