...
<form name=ord_find method=post action=./IndentOrdReportServlet>
<!--
...
<!--
//////////////////////////////////////FORM CONTROLS//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
<h2 >Indent Order Report Search</h2>
<div ><A href=""  onclick="window.close()">Back</A></div>
<center><%=Title1%><input type=text name=ordno onkeyup=search()>&nbsp;&nbsp;<%=Title%>
<input type=text name=supname onkeyup=search()>
...
<%
		if (flag.equals("Sup")){
		   ...
		   out.print("<tr><th>Order Number<th>SP_Name</tr>");
