...
<td>
<input type="text" name="accessNo" id="searchBookCode" class="searchBook" onkeyup="showAccessNo(this.value);" size="15" maxlength=15 >

<!-- <input type="text" name="accessNo" id="searchBookBankCode" class="searchBookBank" onkeyup="showBookBankAccessNo(this.value);" size="15" maxlength=15 > -->
<input type=button name="Find_AccNo" Class="submitButton" Value="Find" onclick="FindValueaccno('accessNoAuth','BOOK BANK')">
</td>
    </div>
</div>
<td Class="addedit">Call&nbsp;No</td><td><input type="text" name="callNo" id="searchCallNo" class="searchBook" onkeyup="showCallNo(this.value);" size="15" maxlength=20>
...
<!-- <td colspan=3><input type="text" name="author"  size="50" maxlength=150 onkeyup="Auth_Select()">  -->
...
<input type=text name=title id="searchTitle" class="searchBook" onkeyup="showTitle(this.value);" size=58 maxlength=255 >
</font></td>
...
<input type="hidden" name="branchName" size="23" value='NIL' readOnly>
 


<td Class="addedit">Location</td><td colspan=3><input type="text" name="location" size="58" maxlength=20></td>
...
<td colspan=3><input type="text" name="supName" id="searchSupplier" class="searchBook" onkeyup="showSuppler(this.value);" size="35" value="NIL"> 
...
<input type="text" name="copies" size="10" value="1" maxlength=3 onKeyUp="return numValidate();">
</td>
...
<!-- 							    <OPTION  VALUE="1"></OPTION> -->
	 ...
	 <td Class="addedit">B&nbsp;Price<td><input type="text" name="bprice" size="10" value="0" maxlength=12 onkeyup="accpt_amt()"></td>
	 </tr>
...
<td colspan=3><input type="text" id="searchBudget" class="searchBook" onkeyup="showBudget(this.value);" name="budName" size="7" value="NIL">
...
<tr>
<td Class="addedit">Keywords<td><input type="text" id="searchKeywords" class="searchBook" onkeyup="showKeywords(this.value);" name="keywords" size="70">
...
<tr>
<td Class="addedit">Series<td><input type="text" name="serTitle" size="80"></td>
...
<td Class="addedit">Meeting&nbsp;Date<td> <INPUT name=otherDate size=15  onfocus=this.blur(); value="<%=dateString%>">
...
<td Class="addedit">Add_Field4</td><td><input type="text" name="addfield4" size="30" maxlength=20></td>
</tr>
