...
<!-- 		<input type="text" name="accessNo" size="15" maxlength=10 onKeyUp="return valid_space()"> -->
		...
		<input type=button name="Find_AccNo" Class="submitButton" Value="Find" onclick="FindValueaccno('accessNoAuth','THESIS')"></td>

		<td Class="addedit">Report.No.</td>
		<td><input type="text" name="addfield1" size="15"></td>
...
<td Class="addedit">Course</td><td ><input type="text" name="addfield3" size="23">
</td>

<td Class="addedit">Degree</td><td><input type="text" name="addfield2" size="15" maxlength=20></td>
  
  
  
<td Class="addedit">Year</td><td><input name="yop" size="15" maxlength=4 onKeyUp="return Year_val();"></td>
...
<!-- <input type=text name=title size=53 onKeyUp="return validTitle_space()"> -->
<input type=text name=title id="searchTitle" class="searchBook" onkeyup="showTitle(this.value);" size=53 >
</font></td>
...
<td colspan=3>
<!-- <input type="text" name="author"  size="45"  onkeyup="Auth_Select()"> -->
<input type="text" name="author" id="searchAuthor" class="searchBook" onkeyup="showAuthor(this.value);" size="45" >
...
<tr>
<td Class="addedit">Int.&nbsp;Guide<td colspan=5><input type="text" name="corAut" size="85" maxlength=100></td>
</tr>

<tr>

<td Class="addedit">Ext.&nbsp;Guide<td colspan=5><input type="text" name="serAut" size="85" maxlength=100></td>
...
<td colspan=6>
 <input type="text" name="deptName" id="searchDept" class="searchBook" onkeyup="showDept(this.value);" size="77" value="NIL">
...
<td colspan=6><input type="text" name="subName" id="searchSubject" class="searchBook" onkeyup="showSubject(this.value);" size="77" value="NIL">
...
<td colspan=6> <input type="text" name="location" size="85" maxlength=100></td>
</tr>


<tr>
<td Class="addedit">Institution</td><td colspan=6><input type="text" name="addfield4" size="85" maxlength=100>
</tr>
...
<tr>
<td Class="addedit">Abstract<td><input type="text" name="summary" size="65" maxlength=180>
</tr>
...
<td Class="addedit">Keywords<td><input type="text" name="keywords" id="searchKeywords" class="searchBook" onkeyup="showKeywords(this.value);" size="57"> 
...
<td Class="addedit">Physical Desc<td colspan=6><input type="text" name="size" size="65" maxlength=50>&nbsp;&nbsp;&nbsp;
</td>
</tr>
<tr>

<!-- <td Class="addedit">Division<FONT color=red size=2>*</FONT></td><tr> -->
<input type="hidden" name="branchName" size="65" value='NIL' readOnly> 
...
<td Class="addedit">ISBN<td >
    <input type="text" name="isbn" size="15" maxlength=13></td>
    </tr>
...
<td ><input name="pubName" value="NIL" size="20">
...
<td ><input type="text" name="supName"  size="20" value="NIL">
<input type=button name="Findsup" Class="submitButton" Value="Find" onclick=FindValue('Sup')>
&nbsp;&nbsp;&nbsp;</td>

<c:choose>
<c:when test="${UserBranchID gt 0}">
<td Class="addedit">Division<FONT color=red size=2>*</FONT></td><td >
<input type="text" name="branchName" size="23" value="<c:out value="${visitBranch}" />" readOnly >
<!-- <input type=button name="FindBranch" Value="Find"  Class="submitButton" onclick="FindValue('Branch')"> -->
</td>
</c:when>
<c:otherwise>
<td Class="addedit">Division<FONT color=red size=2>*</FONT></td><td >
<input type="text" name="branchName" size="23" value="NIL" readOnly >
<input type=button name="FindBranch" Value="Find"  Class="submitButton" onclick="FindValue('Branch')">
</td>
</c:otherwise>
</c:choose>
...
<td Class="addedit">Sub&nbsp;Title</td><td >
...
<td Class="addedit">Script<td ><input type="text" name="script" size="20" maxlength=20>
