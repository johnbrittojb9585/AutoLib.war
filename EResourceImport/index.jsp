...
<jsp:useBean id="bean" scope="request" class="Lib.Auto.EResourceImport.EResourceDataMessage" type="Lib.Auto.EResourceImport.EResourceDataMessage">
</jsp:useBean>
...
<form name="userimport" enctype="multipart/form-data" method="post" action=./ImportEResourceServlet>

<br><br><br>

 <h2>E-Resource Data Import</h2>
<center>
