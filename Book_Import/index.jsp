...
<br><br><br>
<!-- 
 --> <h2>Book Data Import</h2> <input  style="float: left; " type=button name=Save onclick="Help()" Class="submitButton" value=Notes! title="Click to Check Columns!">
<center>
		...
		<tr id="noteBody"> 
			<td> 
				...
				<li><strong style="color:blue"> Excel File Only (.xls). </strong></li><br>
					<li><a href="<%= request.getContextPath() %>/webcontent/birt/Templates/BOOK_TEMPLATE.xls" target=_base><strong style="color:red">Click here to download Template**</strong><img src="<%= request.getContextPath() %>/webcontent/birt/images/download.png" width="1%" height="1%"></a> </li>
				</ul> 
			</td> 
		</tr> 
	</table>
...
function Help()
{
winpopup=window.open("note.jsp?","popup","height=600,width=400,left=50,top=100,scrollbars=yes,toolbar=no,status=yes,menubar=no")
}
</script>
